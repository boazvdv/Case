...
public class Main {
	...
	public static void runSimulation(InstancePostNL postnl, int[][] empToChute, int[][] dsToChute, int runs) {
		...
		for (int i = 0; i < runs; i++) {
			...
			postnl.randomizeSequence();

			// Initialize the simulation
			Simulation sim = new Simulation(postnl);
		...
		System.out.println("Simulation running time: " + (System.currentTimeMillis() - tic) /1000.0 + " seconds");
